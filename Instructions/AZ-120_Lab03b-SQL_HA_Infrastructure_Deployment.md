...
1.  배포에는 약 20분이 소요될 수 있습니다. 배포가 완료될 때까지 기다리지 말고 다음 연습을 진행합니다.
...
### <a name="task-2-examine-the-storage-configuration-of-the-database-tier-azure-vms"></a>작업 2: 데이터베이스 계층 Azure VM의 스토리지 구성을 검사합니다.
