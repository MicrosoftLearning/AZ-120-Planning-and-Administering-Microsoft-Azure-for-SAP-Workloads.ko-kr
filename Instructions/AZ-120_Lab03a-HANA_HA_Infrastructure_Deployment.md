...
### <a name="task-2-connect-to-the-database-tier-azure-vms"></a>작업 2: 데이터베이스 계층 Azure VM에 연결합니다.
...
1.  i20-db-1에 대한 SSH 세션에서 다음을 실행하여 vi 편집기에서 **/root/.ssh/authorized\_keys** 파일을 만듭니다.
